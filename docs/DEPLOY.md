...
2. Products → 建 **Pro（订阅 $4.99/月）** 和 **Lifetime（一次性 $29）** → Copy 各 product ID
...
NEXT_PUBLIC_CREEM_PRODUCT_PRO=prod_xxx   # $4.99/月
NEXT_PUBLIC_CREEM_PRODUCT_LIFETIME=prod_yyy  # $29
```
